...
<div>
            <div class="main__banner"><a class="main__banner-img _ibg" href="#!"><picture>
              <img class="_ibg-img" src="/img/banner/{{$banner}}" width="100" height="100" alt="банер">
            </picture></a></div>
            <section class="match-li">
              ...
              <div class="wrap-tab-ml">
                ...
                <tbody>
                  ...
                  <tr class="mch-tab__tr">
                    <td class="mch-tab__info"><span>{{date('H:i d.m', $event['game_start'])}}</span>
